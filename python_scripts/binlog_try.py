...
#storing mysql setting into a dictionary that will be passed as parameter value to BinlogStreamReader object
mysql_settings={"host":hostname,"port":int(port),"user":username,"passwd":password}
